...
public class Result implements IBase {
    ...
    public <T> Result addCallback(SFunction<T, ?> srcFunc, SFunction<T, ?> targetFunc) {
        return addCallback(ReflectUtils.lambdaField(srcFunc), ReflectUtils.lambdaField(targetFunc));
    }
    ...
    public <T> Result addCallback(SFunction<T, ?> srcFunc, String targetField) {
        return addCallback(ReflectUtils.lambdaField(srcFunc), targetField);
    }
